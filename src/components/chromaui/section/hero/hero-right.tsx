    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className={cn(
              "flex flex-col justify-center order-1 lg:order-2 pt-20 lg:pt-0",
          ...
          {content && (
            <div
              className={cn(
                "flex items-center justify-end lg:justify-center order-2 lg:order-1 w-full lg:w-auto flex-1 lg:flex-none",
